...
import com.flashcat.android.core.internal.account.MutableAccountInfoProvider
import com.flashcat.android.core.internal.account.NoOpMutableAccountInfoProvider
import com.flashcat.android.core.internal.data.upload.CurlInterceptor
import com.flashcat.android.core.internal.data.upload.GzipRequestInterceptor
import com.flashcat.android.core.internal.data.upload.RotatingDnsResolver
import com.flashcat.android.core.internal.net.DefaultFirstPartyHostHeaderTypeResolver
import com.flashcat.android.core.internal.net.info.BroadcastReceiverNetworkInfoProvider
import com.flashcat.android.core.internal.net.info.CallbackNetworkInfoProvider
import com.flashcat.android.core.internal.net.info.NetworkInfoProvider
import com.flashcat.android.core.internal.net.info.NoOpNetworkInfoProvider
import com.flashcat.android.core.internal.persistence.JsonObjectDeserializer
...
import com.flashcat.android.core.internal.persistence.file.writeTextSafe
import com.flashcat.android.core.internal.privacy.ConsentProvider
import com.flashcat.android.core.internal.privacy.NoOpConsentProvider
...
import com.flashcat.android.core.internal.system.NoOpAndroidInfoProvider
import com.flashcat.android.core.internal.system.NoOpAppVersionProvider
import com.flashcat.android.core.internal.system.NoOpSystemInfoProvider
import com.flashcat.android.core.internal.system.SystemInfoProvider
...
import com.flashcat.android.core.internal.thread.ScheduledExecutorServiceFactory
import com.flashcat.android.core.internal.time.AppStartTimeProvider
import com.flashcat.android.core.internal.time.DatadogNtpEndpoint
...
import com.flashcat.android.core.internal.user.MutableUserInfoProvider
import com.flashcat.android.core.internal.user.NoOpMutableUserInfoProvider
import com.flashcat.android.core.internal.utils.executeSafe
import com.flashcat.android.core.internal.utils.unboundInternalLogger
...
internal class CoreFeature(
            ...
            if (BuildConfig.DEBUG) {
                ...
                builder.addInterceptor(
                    HttpLoggingInterceptor { message ->
                        Log.d("DatadogSDK-Network", message)
                    }.apply {
    ...
    private fun addStethoInterceptorIfAvailable(builder: OkHttpClient.Builder) {
        try {
            ...
            val interceptor = stethoInterceptorClass.getDeclaredConstructor().newInstance() as Interceptor
            @Suppress("UnsafeThirdPartyFunctionCall")
